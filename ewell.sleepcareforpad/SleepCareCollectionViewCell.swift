...
class BedModel:NSObject{
    ...
    var BedStatus:BedStatusType{
        ...
        set(value)
        {
            ...
            else if (value == BedStatusType.emptybed){
                //空床
                self.HeadImageView = UIImage(named: "infoHead.png")
                self.BedImageStatus = UIImage(named: "emptybedView.png")
                self.BedImage = UIImage(named: "emptyBed.png")
            }
            else if(value == BedStatusType.unnormal){
                //异常
                self.HeadImageView = UIImage(named: "infoHeadred.png")
                self.BedImageStatus = UIImage(named: "unnormalView.png")
                self.BedImage = UIImage(named: "onBed.png")
            }
            else if(value == BedStatusType.offduty){
                //请假
                self.HeadImageView = UIImage(named: "infoHead.png")
